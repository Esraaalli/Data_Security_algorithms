...
namespace SecurityLibrary
{
    public class Monoalphabetic : ICryptographicTechnique<string, string>
    {
        ...
        public string AnalyseUsingCharFrequency(string cipher)
        {
            ...
            //Creare dectionary to sore each character of cioherText with it's frequency
            ...
            var sortedDict = from entry in cipherFreq orderby entry.Value descending select entry;

            //Map each character in sortedDict to alphabetFreq.
